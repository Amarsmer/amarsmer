...
class Controller(Node):
    def __init__(self):
        ...
        self.declare_parameter('train', False)
    ...
    def run(self):
        ...
        if self.trainer.loss is not None: # Make sure the loss has been initialized
            ...
            if self.trainer.running == True and self.minimal_loss_timer is not None and (current_time - self.minimal_loss_timer) > self.acceptable_loss_delay:
